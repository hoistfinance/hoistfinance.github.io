...
function get_template_A_info(user_info) {
  ...
  str += `</tr>`;
  str += `<tr>`;
  str += `  <td colspan="2"><img style="width: 180px; padding-top: 5px;" src="cid:${logoFileName}" alt="Hoist Finance"/></td>`;
  str += `</tr>`;
...
function get_template_B_info(user_info) {
  ...
  str +=       `<img src='cid:${logoFileName}' style='width: 60px;' alt='Logo' />`;
  str +=     `</td>`;
